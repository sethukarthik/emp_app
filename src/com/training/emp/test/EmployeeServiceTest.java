...
//		System.out.println("---> Find high paid employee with Salary <---");
//		empSalarySet = service.getMaxPaidEmp();
//		System.out.println(empSalarySet);
		
		//8. Find Min paid Employee with Salary
		System.out.println("---> Find min paid employee with Salary <---");
		empSalarySet = service.getMinPaidEmp();
		System.out.println(empSalarySet);
		
		System.out.println("---> Get sum of all employee salary <---");
		double totalSalary = service.totalSal();
